...
# 注册接口 success
# json = {"user_id": "jinx", "password": "123456"}
# url = urljoin("http://127.0.0.1:5000/auth/", "register")
...
# 创建店铺 success
# json = {"user_id": "jinx", "store_id": "1"}
# url = urljoin("http://127.0.0.1:5000/seller/", "create_store")
# r = requests.post(url, json=json)
# print(r)

# 添加库存 success
# json = {"user_id": "jinx", "store_id": "1", "book_id": "1000067", "add_stock_level": 10}
# url = urljoin("http://127.0.0.1:5000/seller/", "add_stock_level")
# r = requests.post(url, json=json)
# print(r)

# 创建订单
json = {"user_id": "jinx", "store_id": "1", "books": [{"id":"1000067", "count": 1},{"id": "1000067", "count": 1}]}
url = urljoin("http://127.0.0.1:5000/buyer/", "new_order")
r = requests.post(url, json=json)
print(r)
